                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-50">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{route('admin.book.update', $lists->id)}}" method="POST"
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    @else
                                                        <textarea name="bookShopUrl" id="bookShopUrl"
                                                                  ...
                                                                  autofocus>{{$lists->bookShopUrl}}</textarea>
                                                    @endif
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    @else
                                                        <textarea name="bookDetails" id="bookDetails"
                                                                  ...
                                                                  autofocus>{{$lists->bookDetails}}</textarea>
                                                    @endif
                                                    <span class="input-filed-error"
                                                          id="testTypeDescriptionError"></span>
                                                </div>
